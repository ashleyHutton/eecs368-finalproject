<?php
	...
	$ses_sql = mysqli_query($db,"SELECT UserName FROM BlogUsers WHERE UserName = '$user_check' ");
	...
	$user_id = mysqli_query($db,"SELECT ID FROM BlogUsers WHERE UserName = '$login_session' ");
